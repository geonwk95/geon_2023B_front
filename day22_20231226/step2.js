...
document.addEventListener( 'DOMContentLoaded' , function(){
    const header = document.querySelector('h1'); console.log(header)
        ...
        //document.querySelector('h1').innerHTML;   해당 요소 사이의 HTML을 텍스트 호출[HTML 코드 자체 읽음]

    header.textContent = 'HEADERS';     // DOM객체명.textContent :  텍스트 호출[HTML 랜더링 결과물]
    header.style.color = 'white';       // DOM객체명.style.css속석명 = '값';
    header.style.backgroundColor = 'black';
        // css : background-color   vs  js : backgroudColor : 카멜표기법
