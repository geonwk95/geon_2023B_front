...
//[p.321] 객체 이동[ !!!! : document( 메모리-객체 1개 - 부모는 언제나 하나여야 한다. )]
document.addEventListener('DOMContentLoaded' , function(){
    ...
    const toFirst = function(){
        ...
        // setTimeout( 함수 , 시간/밀리초(1/1000); ) // 특정(밀리초)시간이 되면 자동으로 함수를 실행하는 함수.
    }
    // 5. 함수2 정의
    ...
    h3.addEventListener('click' , function(event){
        ...
        // 왜??? 클릭 이벤트에 필요한 정보가 있으면 활용해서 쓸수 있도록 지원
        console.log( event );
